...
Framework7.prototype.plugins.main = function (app, params) {
    ...
    if (!params) return;
    var self = this;
    var app = new Framework7({material: true, materialRipple:true});          
    var $$ = Dom7;
            ...
            submitHandler: function (form) {
                ...
                data.done(function(data){
                    if(data == 1){
                        ...
                        view.router.loadPage('account.html');
                        // jobs.show();
                    }
                    else{
                ...
                submitHandler: function (form) {
                    ...
                    data.done(function(data){
                        if(data == 1){
                            ...
                            system.notification("k12","Try other email address.",false,3000,true,function(){},false);
                        }
                        else{
                            system.notification("k12","Failed.",false,3000,true,function(){},false);
                        }
